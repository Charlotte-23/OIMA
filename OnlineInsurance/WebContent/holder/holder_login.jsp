...
<body class="text-center">
	...
	<form class="form-signin" action="holder_login_verification.jsp"
		method="get" onsubmit="return valid()">
		<h1 class="h3 mb-3 font-weight-normal">Policy Holder Login</h1>
		<label for="inputEmail" class="sr-only">ID</label> <input type="text"
			name="ac_no" class="form-control"
			placeholder="Policy Holder Account Number" required autofocus>
