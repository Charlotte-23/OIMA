	...
	<nav class="navbar navbar-dark fixed-top bg-dark">
		...
		<div class="dropdown">
			...
			<div class="dropdown-menu dropdown-menu-right"
				...
				<a class="dropdown-item" href="../holder/holder_login.jsp">Policy Holder</a> <a
					class="dropdown-item" href="../agent/agent_login.jsp">Agent</a>
				<div class="dropdown-divider"></div>
				<a class="dropdown-item" href="../admin/admin_login.jsp">Admin</a>
			</div>
		</div>
	</nav>
	<form class="form-signin" action="admin_login_verification.jsp" method="get"
		onsubmit="return valid()">
		<h1 class="h3 mb-3 font-weight-normal">Admin Login</h1>
		<label for="inputEmail" class="sr-only">ID</label> <input type="text"
			name="uid" class="form-control" placeholder="Admin ID" required
